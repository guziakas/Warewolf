...
namespace Dev2.Activities.Designers2.Demo
{
    public class DemoDesignerViewModel : ActivityCollectionDesignerViewModel<AssignObjectDTO>
    {
        public Func<string> GetDatalistString = () => DataListSingleton.ActiveDataList?.Resource?.DataList;

        public DemoDesignerViewModel(ModelItem modelItem)
            : base(modelItem)
        {
