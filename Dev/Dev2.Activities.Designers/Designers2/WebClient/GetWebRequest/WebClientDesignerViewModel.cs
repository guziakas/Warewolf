...
namespace Dev2.Activities.Designers2.WebClient
{
    public class WebClientDesignerViewModel : ActivityDesignerViewModel
    {
        ...
        public static readonly DependencyProperty IsUrlFocusedProperty =
            DependencyProperty.Register("IsUrlFocused", typeof (bool), typeof (WebClientDesignerViewModel), new PropertyMetadata(false));
